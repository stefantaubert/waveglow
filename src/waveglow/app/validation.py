...
def get_val_dir(train_dir: Path, ds: str, iterations: Set[int], full_run: bool, entry_ids: Optional[Set[int]]) -> None:
  if len(iterations) > 3:
...
def get_val_entry_dir(val_dir: Path, entry: PreparedData, iteration: int) -> None:
